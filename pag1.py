...
def main(data_all,data_geo):
    ...
    show_maps(select_data, threshold(select_data,dicts),dicts)

def threshold(data,dicts):
...
def show_maps(data, threshold_scale,dicts):
